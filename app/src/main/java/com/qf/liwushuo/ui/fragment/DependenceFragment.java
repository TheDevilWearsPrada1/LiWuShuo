...
import com.qf.liwushuo.adapter.ListAdapter;
...
public class DependenceFragment extends BaseFragment1 {

    private XRecyclerView recyclerView;
    private ImageView iv_head;
    ListAdapter adapter_mrtj;
    ...
    private void loadData() {
        RequestParams params = new RequestParams(UrlUtil.Dependence);
    ...
    private void initview() {
        ...
        lists = new ArrayList<>();
        adapter_mrtj = new ListAdapter(lists);
